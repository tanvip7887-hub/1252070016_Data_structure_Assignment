...
In this program we use a singly linked list to store students. Each node has a roll number, name, and next pointer.

We make three lists:

Class list → all students
Cricket list → students who like cricket
Football list → students who like football

When a student is added, we check that roll number is not duplicate. When adding a student to cricket or football list, we first check that 
the student exists in the class.
...
Students who like both (common in both lists)
Students who like only one game (not in both lists)
Students who do not like any game

This program helps us understand how to use linked lists and how to search and compare data in two lists.
...
OUTPUT
-------
C:\Users\USER\OneDrive\Desktop\VS_DS_CPP>g++ ASS14.cpp

C:\Users\USER\OneDrive\Desktop\VS_DS_CPP>a.exe

1. Add a student
2. Assign Cricket fan
3. Assign Football fan
4. Student in class
5. Display students who like Cricket
6. Display students who like Football
7. Display students who like both Cricket and Football
8. Display students who like either Cricket or Football but not both
9. Display number of students who do not like anything
0. Exit
...
Enter your choice: 2
Enter rollno to add in cricket fan team : 1
Student added successfully

Enter your choice: 2
Enter rollno to add in cricket fan team : 3
Student added successfully


Enter your choice: 3
Enter rollno to add in football fan team : 2
Student added successfully

Enter your choice: 3
Enter rollno to add in football fan team : 3
Student added successfully
...
Enter your choice: 9
Students who do not like anything:

(No output because everyone likes something)
