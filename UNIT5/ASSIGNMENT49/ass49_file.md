...
AIM - Write a Program to implement Kruskal’s algorithm to find the minimum spanning tree of a user defined graph. Use Adjacency List to represent a graph.

THEORY 
-------

Graph Representation (Adjacency List):
    Each vertex maintains a list of edges connecting it to neighboring vertices with associated weights.
    Efficient for sparse graphs and easy to iterate over edges.
...
Steps:
    ...
    Pick the smallest edge and check if it forms a cycle using Disjoint Set (Union-Find).
    If it doesn’t form a cycle, include it in the MST.
    Repeat until MST contains (V-1) edges, where V = number of vertices.
    Disjoint Set (Union-Find):
    Efficiently detects cycles when adding edges.
    Supports find (identify set of vertex) and union (combine two sets) operations.
...
C:\Users\USER\OneDrive\Desktop\VS_DS_CPP>g++ ASS49.cpp
